  ...
  return [
    ...
    },
    {
      ...
      about: {
        title: "Tetris",
        description:
          "Tetris- it’s a game that most of us have played on our Nokia phones Except this time it’s color. Rules are pretty simple, you stack all the blocks of similar shapes so that they cancel out,Thereby increasing the points your only goal here is to stop the blocks from hitting the ceiling and gain as many points as you can in the process.",
